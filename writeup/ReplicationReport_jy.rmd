...
### **12/2/2019**
I realized that I did not include the proper covariates in my analyses. In addition to total intracranial volume (TIV), the authors also included age and sex. Note, TIV is automatically adjusted for in VBM8, whereas in CAT12, it is estimated and then manually included in the design matrix. The inclusion of age and gender did not yield significant results though.

### **12/9/2019**

As a check, I conducted the pipeline on the follow-up data using both pipelines. Neither the VBM8 or CAT12 versions yielded significant results (with FWE multiple comparisons corrections). I conducted a series of quality checks using CAT12. 

### Confirmatory analysis

In my pipeline reproduction analysis, the most significant finding observed in the CB group (users) less than HC group (ctrls) was:
